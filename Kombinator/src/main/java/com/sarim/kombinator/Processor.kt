        ...
        override fun visitClassDeclaration(
            ...
            val constructorParameters =
                primaryConstructor.parameters.mapNotNull { ksParam ->
                    ...
                    val parameterKombineAnnotation =
                        ksParam.annotations.firstOrNull {
                            it.annotationType
                                .resolve()
                                .declaration.qualifiedName
                                ?.asString() == annotationClassQualifiedName
            ...
            val hasAnyKombineAnnotationWithPotentialValues =
                classLevelAnnotation != null || constructorParameters.any { it.parameterAnnotation != null }
            ...
            val objectBuilder =
                TypeSpec
                    .objectBuilder(generatedObjectName)
                    .addKdoc(
